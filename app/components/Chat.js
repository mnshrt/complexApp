...
function Chat() {
    ...
    function handleFieldChange(e){
      ...
      setState(draft=>{draft.fieldValue=value}
      )
    }
    useEffect(() => {
    ...
    function handleSubmit(e){
      ...
      setState(draft=>{draft.chatMessages.push({message:draft.fieldValue,username:appState.user.username, avatar: appState.user.avatar})})
      setState(draft=>{
        draft.fieldValue=""
      })
    }
